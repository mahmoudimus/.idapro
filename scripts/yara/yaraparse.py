# https://github.com/CERT-Polska/mquery/blob/master/src/lib/yaraparse.py
import argparse
import itertools
import re
...
def ursify_regex_string(string: Regexp) -> Optional[UrsaExpression]:
    regex_ascii = urisfy_regex(string.unit, is_ascii=True, is_nocase=string.is_nocase)
    regex_wide = urisfy_regex(string.unit, is_wide=True, is_nocase=string.is_nocase)
