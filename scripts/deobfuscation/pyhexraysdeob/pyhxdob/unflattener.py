from cf_flatten_info import cf_flatten_info_t
from def_util import find_forward_stack_var_def, find_numeric_def_backwards
from hexrays_util import (
    mopt_t_to_string,
    report_debug,
    report_error,
    report_error3,
...
from target_util import (
    deferred_graph_modifier_t,
    remove_single_gotos,
    split_mblocks_by_jcc_ending,
)
...
class cf_unflattener_t(ida_hexrays.optblock_t):
    """
