...
@dataclass
class RemoveJunkActionHandler(ida_helpers.BaseActionHandler):
    """Removes junk instructions (long NOPs, UD2, invalid)."""

    action_name: str = "mutilz:remove_junk"
    action_label: str = "Remove Junk Instructions"
...
class RemoveJunkAction(actions.action_t, metaclass=ida_helpers.HookedActionMeta):
    uihook_class = functools.partial(
        ida_helpers.PopUpHook,
        RemoveJunkActionHandler,
