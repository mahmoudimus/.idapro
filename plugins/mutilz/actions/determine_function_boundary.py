# generated by mutilz cli at 2025-04-08 22:56:12
import dataclasses
import functools
import logging
...
log_boundary = logging.getLogger("mutilz.actions.determine_function_boundary")
configure_debug_logging(log=log_boundary)
...
class DetermineFunctionBoundaryActionHandler(ida_helpers.BaseActionHandler):
    """Determine Function Boundary"""

    action_name: str = "mutilz:determine_function_boundary"
    action_label: str = "Determine Function Boundary"
    icon: int = 205
...
def get_action() -> actions.action_t:
    return DetermineFunctionBoundaryAction()
