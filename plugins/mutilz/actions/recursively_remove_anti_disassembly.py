...
from mutilz.actions.remove_anti_disassembly import (
...
def recursively_remove_anti_disassembly(
    start_func_ea, max_depth, patch_manager, visited=None, current_depth=0
):
    ...
    decompiled_code = execute_action(
        start_func_ea, end_ea, patch_manager=patch_manager, force_analyze=True
    )
        ...
        if called_ea not in visited:
            ...
            if current_depth < max_depth:
                sub_results = recursively_remove_anti_disassembly(
                    called_ea, max_depth, patch_manager, visited, current_depth + 1
                )
